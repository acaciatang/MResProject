...
output = rmfield(R, {'FilledImage', 'isQuad', 'passCode', 'orientation', 'BoundingBox', 'code'});
[filepath,name,ext] = fileparts(images(iter).name);
save([name '.mat'], 'output');
hold off;
end
%%