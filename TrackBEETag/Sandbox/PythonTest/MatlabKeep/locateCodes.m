function R = locateCodes(im, varargin)
    ...
    if sum(v) == 0
        ...
        vis = str2double(varargin(find(v == 1) + 1));
    end
    ...
    if sum(colM) == 0
        ...
        colMode = str2double(varargin(find(colM == 1) + 1));
    end
    ...
    if sum(tagTh) == 0
        ...
        sizeThresh = str2double(varargin(find(tagTh == 1) + 1));
    end
    ...
    if sum(threshM) == 0
        ...
        threshMode = str2double(varargin(find(threshM == 1) + 1));
    end
    ...
    if sum(bradleyP) == 0
        ...
        smP = str2double(varargin(find(bradleyP == 1) + 1));
    end
    ...
    if sum(bradleyT) == 0
        ...
        brT = str2double(varargin(find(bradleyT == 1) + 1));
    end
    ...
    if sum(th) == 0
        ...
        thresh = str2double(varargin(find(th == 1) + 1));
    end
    ...
    if sum(trackM) == 0
        ...
        trackMode = 1;
        imo = str2double(varargin(find(trackM == 1) + 1));
    end
    ...
    if sum(listM) == 0
        ...
        listMode = 1;
        validTagList = str2double(varargin(find(listM == 1) + 1));
    end
